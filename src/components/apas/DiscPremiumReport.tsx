...
import apasLogoLightAsset from "@/assets/apas-logo-light.webp.asset.json";
...
function ApasBrand({ inverse = false }: { inverse?: boolean }) {
  return <span className={`disc-brand ${inverse ? "disc-brand-inverse" : ""}`} aria-label="APAS Soluções"><img className="disc-brand-logo" src={inverse ? apasLogoAsset.url : apasLogoLightAsset.url} alt="" /></span>;
}
