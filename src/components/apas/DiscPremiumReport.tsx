...
function Page({ number, title, eyebrow, icon: Icon, children, cover = false, dark = [3, 6, 8, 10, 12].includes(number) }: { number: number; title?: string; eyebrow?: string; icon?: LucideIcon; children: ReactNode; cover?: boolean; dark?: boolean }) {
