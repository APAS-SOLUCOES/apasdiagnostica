...
const makeScores = (
  ...
  adaptationIndex: Math.round((Math.abs(percent.D - natural.D) + Math.abs(percent.I - natural.I) + Math.abs(percent.S - natural.S) + Math.abs(percent.C - natural.C)) * 10) / 10,
  adaptationAlert: Math.abs(percent.D - natural.D) + Math.abs(percent.I - natural.I) + Math.abs(percent.S - natural.S) + Math.abs(percent.C - natural.C) > 20,
